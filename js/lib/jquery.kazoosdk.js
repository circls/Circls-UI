(function ( $ ) {
	...
	methodsGenerator = {
		...
		balance: {
			...
			'getFraud': { verb: 'GET', url: 'accounts/{accountId}/transactions/fraud' },
		...
		channel: {
			...
			'action': { verb: 'POST', url: 'accounts/{accountId}/channels/{callId}' }
		},
		clickToCall: {
		...
		conference: {
			...
			'action': { verb: 'PUT', url: 'accounts/{accountId}/conferences/{conferenceId}/{action}' },
		...
		allotments: {
			'list': { verb: 'GET', url: 'accounts/{accountId}/allotments' },
			'update': { verb: 'POST', url: 'accounts/{accountId}/allotments' },
			'consumed': { verb: 'GET', url: 'accounts/{accountId}/allotments/consumed' },
			'period': { verb: 'GET', url: 'accounts/{accountId}/allotments/consumed?created_from={fromTime}&created_to={toTime}' },
			'certainfrom': { verb: 'GET', url: 'accounts/{accountId}/allotments/consumed?created_from={fromTime}' },
			'certainto': { verb: 'GET', url: 'accounts/{accountId}/allotments/consumed?created_to={toTime}' },
			'delete': { verb: 'DELETE', url: 'accounts/{accountId}/allotments' },
		},
		limits: {
		...
		voicemail: {
			...
			'agents_update': { 'verb': 'POST', 'url': 'accounts/{accountId}/queues/{queuesId}/roster' },
                ...
                lcrrates: {
                        'get':    { 'verb': 'GET', 'url': 'accounts/{accountId}/lcrrates/{rateId}' },
                        'create': { 'verb': 'PUT', 'url': 'accounts/{accountId}/lcrrates' },
                        'update': { 'verb': 'POST', 'url': 'accounts/{accountId}/lcrrates/{rateId}' },
                        'delete': { 'verb': 'DELETE', 'url': 'accounts/{accountId}/lcrrates/{rateId}' },
                        'list':   { 'verb': 'GET', 'url': 'accounts/{accountId}/lcrrates' },
                        'accountSummary': { 'verb': 'GET', 'url': 'accounts/{accountId}/lcrrates/summary' },
                        'summary':        { 'verb': 'GET', 'url': 'accounts/{accountId}/lcrrates/{rateId}/summary' },
                        'upload': { verb: 'POST', url: 'accounts/{accountId}/lcrrates', type: 'text/csv', dataType: 'text' }
                },
                provisioner: {
			...
			'dialplans': {verb:"GET",url:"accounts/{accountId}/dialplans"},
                ...
                currencies: {
                        'get': { verb: 'GET', url: 'accounts/{accountId}/currencies/{currenciesId}' },
                        'create': { verb: 'PUT', url: 'accounts/{accountId}/currencies' },
                        'update': { verb: 'POST', url: 'accounts/{accountId}/currencies/{currenciesId}' },
                        'delete': { verb: 'DELETE', url: 'accounts/{accountId}/currencies/{currenciesId}' },
                        'list': { verb: 'GET', url: 'accounts/{accountId}/currencies' }
                },
                taxes: {
                        'get': { verb: 'GET', url: 'accounts/{accountId}/taxes/{taxesId}' },
                        'create': { verb: 'PUT', url: 'accounts/{accountId}/taxes' },
                        'update': { verb: 'POST', url: 'accounts/{accountId}/taxes/{taxesId}' },
                        'delete': { verb: 'DELETE', url: 'accounts/{accountId}/taxes/{taxesId}' },
                        'list': { verb: 'GET', url: 'accounts/{accountId}/taxes' }
                },
                dnscontroller: {
                        'get': { verb: 'GET', url: 'accounts/{accountId}/dnscontroller/{dnscontrollerId}' },
                        'create': { verb: 'PUT', url: 'accounts/{accountId}/dnscontroller' },
                        'update': { verb: 'POST', url: 'accounts/{accountId}/dnscontroller/{dnscontrollerId}' },
                        'delete': { verb: 'DELETE', url: 'accounts/{accountId}/dnscontroller/{dnscontrollerId}' },
                        'list': { verb: 'GET', url: 'accounts/{accountId}/dnscontroller' }
                },
                subdomains: {
                        'get': { verb: 'GET', url: 'accounts/{accountId}/entries/{listId}/subdomains' },
                        'create': { verb: 'PUT', url: 'accounts/{accountId}/entries/subdomains' },
                        'update': { verb: 'POST', url: 'accounts/{accountId}/entries/{listId}/subdomains' },
                        'delete': { verb: 'DELETE', url: 'accounts/{accountId}/entries/{listId}/subdomains' },
                        'list': { verb: 'GET', url: 'accounts/{accountId}/entries/subdomains' }
                },
                crmintegration: {
                        'get': { verb: 'GET', url: 'accounts/{accountId}/entries/{listId}/crmintegration' },
                        'create': { verb: 'PUT', url: 'accounts/{accountId}/entries/crmintegration' },
                        'update': { verb: 'POST', url: 'accounts/{accountId}/entries/{listId}/crmintegration' },
                        'delete': { verb: 'DELETE', url: 'accounts/{accountId}/entries/{listId}/crmintegration' },
                        'list': { verb: 'GET', url: 'accounts/{accountId}/entries/crmintegration' }
                },
                faxintegration: {
                        'get': { verb: 'GET', url: 'accounts/{accountId}/entries/{listId}/faxintegration' },
                        'create': { verb: 'PUT', url: 'accounts/{accountId}/entries/faxintegration' },
                        'update': { verb: 'POST', url: 'accounts/{accountId}/entries/{listId}/faxintegration' },
                        'delete': { verb: 'DELETE', url: 'accounts/{accountId}/entries/{listId}/faxintegration' },
                        'list': { verb: 'GET', url: 'accounts/{accountId}/entries/faxintegration' }
                },
                medicare: {
                        'get': { verb: 'GET', url: 'accounts/{accountId}/entries/{listId}/medicare' },
                        'create': { verb: 'PUT', url: 'accounts/{accountId}/entries/medicare' },
                        'update': { verb: 'POST', url: 'accounts/{accountId}/entries/{listId}/medicare' },
                        'delete': { verb: 'DELETE', url: 'accounts/{accountId}/entries/{listId}/medicare' },
                        'list': { verb: 'GET', url: 'accounts/{accountId}/entries/medicare' }
                },
                medicareplus: {
                        'get': { verb: 'GET', url: 'accounts/{accountId}/entries/{listId}/medicareplus' },
                        'create': { verb: 'PUT', url: 'accounts/{accountId}/entries/medicareplus' },
                        'update': { verb: 'POST', url: 'accounts/{accountId}/entries/{listId}/medicareplus' },
                        'delete': { verb: 'DELETE', url: 'accounts/{accountId}/entries/{listId}/medicareplus' },
                        'list': { verb: 'GET', url: 'accounts/{accountId}/entries/medicareplus' }
                }
        },
	authTokens = {};
