define(["require", "jquery", "underscore", "monster", "toastr", "monster-flags", "chosenImage"], function(require) {
    var $ = require("jquery"),
        ...
        app = {
            requests: {},
            subscribe: {
                "lcrrates.lcrrates.render": "lcrratesRender"
            },
            appFlags: {
                tableData: []
            },
...
//        console.log(monster.resource_ids);
            ...
            switch (v) {
                ...
                var self = this;
                    table = [
                    {
                        ...
                        fnRender: function(data) {
                            if(typeof monster.resource_ids === 'undefined')
                                return data.aData[2];
                            else return monster.resource_ids[data.aData[2]]['name'];
                        }
                    }, {
