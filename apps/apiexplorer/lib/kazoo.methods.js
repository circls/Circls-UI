{
	...
	"pivot": {
        ...
        "phonebook": {
                ...
                "create": { "verb": "PUT", "url": "accounts/{accountId}/phonebook", "schemas": "schemas/phonebook" },
                "update": { "verb": "POST", "url": "accounts/{accountId}/phonebook/{phonebookId}", "schemas": "schemas/phonebook" },
	...
	"presence": {
        ...
        "provisioner": {
                ...
                "update": { "verb": "POST", "url": "accounts/{accountId}/provisioner/{gatewayId}", "schemas": "schemas/provisioner" },
                "delete": { "verb": "DELETE", "url": "accounts/{accountId}/provisioner/{gatewayId}", "schemas": "schemas/provisioner" },
                ...
                "upload": { "verb": "POST", "url": "accounts/{accountId}/provisioner", "type": "text/json", "dataType": "text", "schemas": "schemas/provisioner" }
        },
        "queues": {
                "title": "Queues",
                ...
                "queues_create": { "verb": "PUT", "url": "accounts/{accountId}/queues", "schemas": "schemas/queues" },
                "queues_update": { "verb": "POST", "url": "accounts/{accountId}/queues/{queuesId}", "schemas": "schemas/queues" },
        ...
        "agents": {
                ...
                "agents_update": { "verb": "POST", "url": "accounts/{accountId}/queues/{queuesId}/roster", "schemas": "schemas/agents" },
        ...
        "rates": {
                ...
                "create": { "verb": "PUT", "url": "accounts/{accountId}/rates", "schemas": "schemas/rates" },
                "update": { "verb": "POST", "url": "accounts/{accountId}/rates/{rateId}", "schemas": "schemas/rates"},
                ...
                "upload": { "verb": "POST", "url": "accounts/{accountId}/rates", "type": "text/csv", "dataType": "text", "schemas": "schemas/rates" }
        },
        "lcrrates": {
                "title": "LCR-Rates",
                "get":    { "verb": "GET", "url": "accounts/{accountId}/lcrrates/{rateId}" },
                "create": { "verb": "PUT", "url": "accounts/{accountId}/lcrrates", "schemas": "schemas/lcrrates" },
                "update": { "verb": "POST", "url": "accounts/{accountId}/lcrrates/{rateId}", "schemas": "schemas/lcrrates"},
                ...
                "upload": { "verb": "POST", "url": "accounts/{accountId}/lcrrates", "type": "text/csv", "dataType": "text", "schemas": "schemas/lcrrates" }
        },
        "acls": {
                "title": "ACLs",
                "list":   { "verb": "GET", "url": "accounts/{accountId}/acls" }
        },
	"registrations": {
		"title": "Registrations",
