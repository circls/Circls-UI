define(["require", "jquery", "underscore", "monster"], function(e) {
    var $ = e("jquery"),
        ...
        app = {
            ...
            requests: {},
            subscribe: {},
            subModules: ["lcrrates", "taxes", "currencies", "dnscontroller", "subdomains"],
            ...
            render: function(callback) {
                ...
                template.find(".category#lcrrates").addClass("active"), monster.pub("carriersettings.lcrrates.render", {
            ...
            bindEvents: function(callback) {
                ...
                callback.find(".category").on("click", function() {
                    ...
                    callback.find(".category").removeClass("active"), self.toggleClass("active"), content.empty(), monster.pub("carriersettings." + attribut + ".render", option)
                })
            }
        };
    return app
